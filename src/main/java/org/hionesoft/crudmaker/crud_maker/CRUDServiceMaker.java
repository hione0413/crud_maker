...
@Component
public class CRUDServiceMaker extends CRUDMaker {

    public File makeServiceInterface(CRUDMakerVo crudMakerInfos) throws IOException {
        String dtoName = crudMakerInfos.getDtoName();

        ClassPathResource bluePrintResource = this.getBluePrintResource("crud_blue_print/service_interface_blue_print.java");
    ...
    public File makeServiceImplClass(CRUDMakerVo crudMakerInfos) throws IOException {
        String dtoName = crudMakerInfos.getDtoName();

        ClassPathResource bluePrintResource = this.getBluePrintResource("crud_blue_print/service_impl_blue_print.java");
        File blueprint = bluePrintResource.getFile();
        File tempFile = readyCrudTempFile(bluePrintResource);
